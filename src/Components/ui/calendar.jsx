...
function Calendar({
    ...
    const sizes = {
        sm: "[--cell-size:1.75rem]", // 28px
        md: "[--cell-size:2.5rem]",  // 40px
        lg: "[--cell-size:2.5rem] lg:[--cell-size:4rem]"     // 40px on mobile, 64px on desktop
    }
    ...
    return (
        <DayPicker
            ...
            className={cn(
                "p-2 [--cell-radius:var(--radius-md)] bg-background group/calendar [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
                sizes[size],
