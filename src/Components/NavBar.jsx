      ...
      <div className="h-full w-full flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          ...
          <div className="flex items-center space-x-8 ms-7 lg:ms-20 xl:ms-28">
            <button
              onClick={() =>
                nav("/free-session", { state: { option: "Free Test" } })
              }
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 text-center sm:px-3">
            <div
              onClick={toggleLanguage}
              className="flex justify-center cursor-pointer text-[var(--Main)] items-center space-x-2"
            >
              <FontAwesomeIcon icon={faEarth} />
              {i18n.language === "en" ? (
                <span>{t("Arabic")}</span>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-[var(--Yellow)] font-bold block"
                  : "text-[var(--Main)] block"
              }
            >
              {t("Home")}
            ...
            <NavLink
              to="/free-session"
              state={{ option: "Free Test" }}
              className="text-[var(--Main)] block"
            >
              {t("BookFree")}
            </NavLink>
          </div>
