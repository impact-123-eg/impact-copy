  ...
  useEffect(() => {
    const fetchExchangeRate = async () => {
      try {
        ...
        setFinalPriceAfter(formatPrice(props.priceAfter, rate, currencyCode));
        setFinalPriceBefore(formatPrice(props.priceBefore, rate, currencyCode));
        ...
        >
          ...
          <div className="relative z-20 space-y-8 mt-4">
            <h1 className="text-xl md:text-3xl text-[var(--Yellow)] font-bold">
              {i18n.language === "en" ? props.Name : props.NameAr}
            </h1>
            ...
            <div className="space-y-4">
              {props.priceBefore !== 0 && (
                <h3 className="text-4xl md:text-xl line-through text-gray-200">
                  {loading
                    ? "Loading..."
                    : Number(props.priceBefore) > 0
                    ? finalPriceBefore || `${props.priceBefore} USD`
                    : null}
                </h3>
              )}
              <h3 className="text-4xl md:text-4xl font-bold">
                {loading
                  ? "Loading..."
                  : finalPriceAfter || props.priceAfter + " USD"}
              </h3>
            </div>

            <div className="space-y-6 text-2xl">
              <h1>
                {i18n.language === "en" ? props.SessionNo : props.SessionNoAr}
              </h1>
              <p>
                {props.TotalTimeNo}{" "}
                {i18n.language === "en"
                  ? props.TotalTimeUnit
                  : props.TotalTimeUnitAr}
              </p>
              <p>
                {i18n.language === "en"
                  ? props.SessionPerWeek
                  : props.SessionPerWeekAr}
              </p>
              <p>{i18n.language === "en" ? props.Hours : props.HoursAr}</p>
              <p>
                {i18n.language === "en"
                  ? props.ScheduleType
                  : props.ScheduleTypeAr}
              </p>
            </div>
